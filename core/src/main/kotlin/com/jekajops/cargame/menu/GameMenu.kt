...
package com.jekajops.cargame.menu
...
import com.jekajops.cargame.actors.scene2d.PlayPauseResumeButton
import com.jekajops.cargame.actors.scene2d.Score
import com.jekajops.cargame.actors.scene2d.Timer
...
class GameMenu : Disposable {
    ...
    constructor() {
        ...
        table.add(pauseResumeButton).top().left().size(GameSettings.WIDTH * 0.06f).padRight(
            GameSettings.WIDTH * 0.02f)
