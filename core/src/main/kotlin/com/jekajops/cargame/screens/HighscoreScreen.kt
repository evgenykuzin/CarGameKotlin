...
import com.jekajops.cargame.actors.scene2d.HighScoreTable
...
class HighscoreScreen : Screen {
    ...
    private fun createExitButton(): ImageButton? {
        val exitButton = ImageButton(ImageButton.ImageButtonStyle(TextureRegionDrawable(
            AssetsManager.textureMap[Resources.RegionNames.BUTTON_QUIT_NAME.name]), null, null, null, null, null))
